...
<script type="text/javascript"  src="<c:url value='/view/bus/purchase/operate/create_purchase.js'/>"></script>
	...
	<div class="content" style='font-family:"微软雅黑";height:92%'>
		...
		<div class="step-wrap" style="width:97%;">
			<div class="step-content display" id="reorderInfo"> 
				<div class="left" style="margin-top:-5px;width:25%;border-width:1px 1px 1px 0;">
					<form id="reorderfm" name="reorderfm" method="post" >				
						<ul>
							...
							<li class="tl6">&nbsp; <input class="easyui-combobox" editable="false" type="text" name="setWay" data-options="data:setWay,valueField:'id',textField:'text',panelHeight:'auto'" /> 
							</li>
				...
				<div class="right" style="margin-top:-10px;width:74%;height:60%;border-width:1px 0px 1px 1px;border-style:solid;border-color:#ddd;">
