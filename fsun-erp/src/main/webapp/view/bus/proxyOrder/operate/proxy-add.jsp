	...
	$('#finishBtn').on('click',function(){	      
        ...
        if(oFile.value == ""){ 
        	...
        	$.ajax({
    	        ...
    	        async:false,
    	        url: '<c:url value="/bus/proxyOrder/saveEntry"/>',
...
function initCustomerCombo(customerCode){
	...
	$("#customerCode",$headerForm).combogrid({
	      ...
	      queryParams: {enabled: true, type:1, q:customerCode},
	      multiple: false,
	      fitColumns: true,
	      striped: true,
	      editable: true,
...
function initForm($headerForm, $detailForm){
	...
	$('#receiveTime',$headerForm).datebox("setValue",GetDateStr(3)); 
	$('#createTime',$headerForm).datebox("setValue",GetDateStr(0)); 
...
<body>
	<div class="content" style='font-family:"微软雅黑";height:95%'>
		...
		<div class="right" style="margin-right:10px;">
			<input type="button" class="blue-btn" id="finishBtn" value="生成加工单" />
		</div>
			    ...
			    <div class="left" style="margin-top:-10px;width:24%;border-width:1px 1px 1px 0;">
					<form id="proxyHeaderfm" name="proxyHeaderfm" >	
						...
						<ul>	
							...
							<li class="tl6" >&nbsp; <input id="createManName" readOnly value="${createManName}" type="text" style="width:156px;"></input></li>
