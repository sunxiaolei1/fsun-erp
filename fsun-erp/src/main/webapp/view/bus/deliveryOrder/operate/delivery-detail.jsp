...
$(function(){
	...
	$.ajax({
       	url:'<c:url value="/bus/deliveryOrder/getEntry" />',
       	dataType: "json",
       	data: {deliveryCode:'${deliveryCode}'},
       	success:function(rowData){
       		if(rowData.success){
    			var deliveryOrderDto =  rowData.rows;	
    			deliveryDetailDtos = deliveryOrderDto.deliveryDetailDtos;
       			var headerData = deliveryOrderDto.deliveryHeaderDto;
       			...
       			$("#customerCode",$form).combogrid({
       		      ...
       		      queryParams: {enabled: true, q:headerData.customerCode},
       		      multiple: false,
       		      fitColumns: true,
       		      striped: true,
       		      editable: true,
       			...
       			if(!headerData.received){
       				...
       				$('#finishBtn').on('click',function(){
       				    ...
       				    var date = deliveryHeaderDto.deliveryDate+"";
       					...
       					$.ajax({
       				        ...
       				        async:false,
       				        url: '<c:url value="/bus/deliveryOrder/updateEntry"/>',
...
<body>
	<div class="content" style='font-family:"微软雅黑";height:92%'>
		...
		<h3 class="title" style="margin-top:4px;">送货明细</h3>
	...
	<div id="detailToolbar" style="display:none">	
		 ...
		 <a	href="javascript:void(0)" class="easyui-linkbutton"	iconCls="icon-delete" plain="true"  onclick="delEdits($('#detailTable'),$('#orderfm'))">删除</a>	
