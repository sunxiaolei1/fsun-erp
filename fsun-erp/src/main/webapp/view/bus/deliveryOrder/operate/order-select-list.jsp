...
<body>
	...
	<div id="order-toolbar"  style="padding:2px;display:none;" >
		 <span style="float:right;margin-top:2px;">	
		 	<label>订单号：</label>
			<input id="order-orderCodeText" style="width:150px"  />
			<label>产品:</label>
		 ...
		 <a href="javascript:void(0)" class="easyui-linkbutton"	iconCls="icon-save" plain="true" onclick="javascript:getOrderDetailIds()">确定</a>	 
	</div>
	<script type="text/javascript">
		...
		//提交明细id并跳转至新增生产单界面
		function getOrderDetailIds(){
			if(orderDetailIds.length>0){
				window.parent.closeOrderWin();
				window.parent.toAddDeliveryPage(orderDetailIds.join(","));
			}else{
