...
var filters = {title : "pictrue files", extensions : "jpeg,bmp,png,jpg,gif"};
$("#uploader").pluploadQueue(
	$.extend(
		{
			runtimes : 'flash,html4,html5',
			url : "<c:url value='/bus/outsourcDetail/pictrueImport'/>?outSideId=${param.outSideId}",
			resize : {width : 560, height : 420, quality : 95},
