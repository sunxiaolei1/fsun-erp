...
<div class="easyui-layout" style="width:100%;height:100%;">
	<div region="center" border="false"  >
		<div id="madeHeaderTabs" class="easyui-tabs" fit=true >
			<div title="生产单列表" data-options="region:'center',split:true,collapsible:false" >
			...
			<div title="生产单及明细" data-options="region:'center',split:true,collapsible:false" style="padding:5px">
			</div>
...
<%@include file="./operate/made-operate.jsp"%>
...
<script type="text/javascript">
	...
	function shortcutOrder(){	
		window.location.href = "<c:url value='/bus/madeOrder/shortcutOrder'/>";
	}
	...
	//跳转到添加生产单界面
    function toAddMadeHeaderPage(orderDetailIds){
    	toEdit = false;
    ...
    function toMadeDetailsPage(){
    	...
    	if(rows!=null && rows.length==1){
    		...
    		$.messager.alert('提示',"请选择一个生产单查看详情!",'info');
    	}
    }
    ...
    //跳转到生产单列表界面
    function toAddMadeListPage(madeCode){
    	currMadeCode = madeCode;
...
<script type="text/javascript">
   ...
   //设置要显示的列名
    ...
    [[
		...
		{field:"madeCode",title:"生产单号",width:200,align:"center"},
		{field:"orderCode",title:"订单号",width:200,align:"center"},
		{field:"madeTypeName",title:"单据类型",width:100,align:"center"},
		{field:"madeStatus",title:"单据状态",width:100,align:"center"},
		{field:"printStatus",title:"打印状态",width:130,align:"center", formatter:format_printStatus},
		{field:"createManName",title:"制单人",width:130,align:"center"},
    ...
    function initDataGrid() {
    	...
    	detailGird.datagrid({
            ...
            fit:true,//自动大小
            url:'<c:url value="/bus/madeOrder/search"/>',
            queryParams:{},
            remoteSort:true,
            sortName:"createTime",
            sortOrder:"desc",
   				...
   				if(data.rows.length>0){         				   	
    	        	...
    	        	$(this).datagrid("fixRownumber");
       				...
       				for (var i = 0; i < rows.length; i++) {
						if(currMadeCode==rows[i].madeCode){
    	...
    	$("#madeHeaderTabs").tabs({
			...
			onSelect:function(title, index){
				if(index == 0){					
	    			...
	    			var url = '<c:url value="/bus/madeOrder/madeAdd-'+ selectedOrderDetailIds +'"/>';
	    			var content = "<iframe scrolling='auto' frameborder='0' src='"+ url +"' style='width:100%;height:100%;'></iframe>";
	    			if(toEdit){
	    				var row = detailGird.datagrid("getSelected");
	    				var madeCode = "";
	    				if(row){	
	    					madeCode = row.madeCode; 
	    				}
	    				url = '<c:url value="/bus/madeOrder/madeDetail-'+ madeCode +'"/>';
    				...
    				var url = '<c:url value="/bus/madeOrder/order-relation-'+ madeCode +'"/>';
    				content = "<iframe scrolling='auto' frameborder='0' src='"+ url +"' style='width:100%;height:100%;'></iframe>";
	    			$(this).tabs("update", {
						tab: currentTab,
						options: {
