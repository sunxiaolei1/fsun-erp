...
$(function(){
	...
	$.ajax({
       	url:'<c:url value="/bus/madeOrder/getEntry" />',
       	dataType: "json",
       	data: {madeCode:'${madeCode}'},
       	success:function(rowData){
       		if(rowData.success){
    			var madeOrderDto =  rowData.rows;	
       			madePackageDtos = madeOrderDto.madePackageDtos;
       			madeDetailDtos = madeOrderDto.madeDetailDtos;
       			madeProcessDtos = madeOrderDto.madeProcessDtos;
       			var headerData = madeOrderDto.madeHeaderDto;
       			...
       			if(headerData.enabled){
       				$('#finishBtn').on('click',function(){
       					...
       					$.ajax({
       				        ...
       				        async:false,
       				        url: '<c:url value="/bus/madeOrder/updateEntry"/>',
...
[[
	...
	{field:"description",title:"备注",width:80,align:"center", styler:printProcess}
]];
...
<body>
	<div class="content" style='font-family:"微软雅黑";height:92%'>
		...
		<div id="finishBtnDiv" class="right" style="margin-right:10px;display:none;">
			<input type="button" class="blue-btn" id="finishBtn" value="更新" />
		</div>
		<h3 class="title" style="margin-top:4px;">生产明细</h3>
		<div class="step-wrap" style="width:99%;">
			<div class="step-content display" style="padding: 15px 0 0 0;"> 
				<form id="orderfm" name="orderfm" method="post" >	
				    ...
				    <input name="printStatus" hidden=true>
				    <input name="createManId" hidden=true>
				    <input name="createManName" hidden=true>
				    <input name="createTime" hidden=true>
				    <input name="enabled" hidden=true>			
					<ul>	
						<li class="tr2"><span class="red-font">*</span> 生产单号：</li>
						<li class="tl7">&nbsp; <input name="madeCode" id="madeCode" disabled="true" style="width:180px;"/></li>									
