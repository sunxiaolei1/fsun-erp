...
if (needCLodop()) {
	...
	//oscript.src ="http://192.168.6.124:8000/CLodopfuncs.js?priority=0";
	//head.insertBefore( oscript,head.firstChild );
	...
	//oscript = document.createElement("script");
	//oscript.src ="http://192.168.6.124:18000/CLodopfuncs.js?name=LODOPD&priority=0";
	//head.insertBefore( oscript,head.firstChild );
};
...
function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='CLodop_Setup_for_Win32NT.zip' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
    var strCLodopUpdate="<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='CLodop_Setup_for_Win32NT.zip' target='_self'>执行升级</a>,升级后请刷新页面。</font>";
    var LODOP;
    try{
