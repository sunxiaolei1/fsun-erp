					...
					"flash",
					{
						...
						init : function(m, o) {
							...
							d.extend(l.style, {
								position : "absolute",
								top : "0px",
								background : m.settings.shim_bgcolor
										|| "transparent",
								zIndex : 99999,
								width : "100%",
								height : "100%"
							...
							(function() {
								...
								p = '<object id="'
										...
										+ m.settings.flash_swf_url + '" ';
								if (d.ua.ie) {
									p += 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" '
								}
								p += 'width="100%" height="100%" style="outline:0"><param name="movie" value="'
										+ m.settings.flash_swf_url
												...
												m
														.bind(
																...
																function(s) {
																	var t, u;
																	t = b
																			.getElementById(m.settings.browse_button);
